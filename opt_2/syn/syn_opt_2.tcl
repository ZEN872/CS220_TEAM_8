...
set REPORT_DIR "${HOME}/opt_2/syn/rvt_reports"
...
read_sverilog ${DESIGN_RTL_DIR}/../opt_2/rtl/clock_divider.sv
# Read the AVFS controller (Adaptive Voltage and Frequency Scaling) optimization file.
read_sverilog ${DESIGN_RTL_DIR}/../opt_2/rtl/avfs_controller_optimization-2.sv
