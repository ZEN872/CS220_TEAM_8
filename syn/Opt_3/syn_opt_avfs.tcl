...
set REPORT_DIR "${HOME}/syn/Opt_3/rvt_reports"
...
# Read clock divider for dynamic clock generation controlled by the AVFS controller.
read_sverilog ${DESIGN_RTL_DIR}/Opt_3/rtl/clock_divider.sv
# Read the AVFS controller (Adaptive Voltage and Frequency Scaling) optimization file.
read_sverilog ${DESIGN_RTL_DIR}/Opt_3/rtl/avfs_controller_optimization-2.sv
