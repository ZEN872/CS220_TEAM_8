...
set REPORT_DIR "${HOME}/syn/Opt_2/rvt_reports"
...
read_sverilog ${DESIGN_RTL_DIR}/Opt_2/tcm_partition_ctrl.sv
# I-TCM memory model (behavioral model; modify for synthesis as needed)
read_sverilog ${DESIGN_RTL_DIR}/Opt_2/i_tcm.sv
# D-TCM memory model (behavioral model; modify for synthesis as needed)
read_sverilog ${DESIGN_RTL_DIR}/Opt_2/d_tcm.sv
